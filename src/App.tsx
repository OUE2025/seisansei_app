...
import { Sun, Check, ChevronRight, AlertCircle, BarChart3, Clock, Smartphone, RotateCcw, ClipboardCheck, ListTodo, ArrowLeft, FileText, HelpCircle, X, CornerDownRight, CheckCircle2, Tablet, Monitor, Download, Loader2 } from 'lucide-react';

type DeviceKey = 'sensor' | 'income' | 'record';
type ResultType = 'S' | 'A' | 'B';

type ChecklistSubItemData = { id: string; text: string };
...
const TOP_LOGO = assetUrl('top01.webp');
const GOKAI_CLOUD = assetUrl('gokai01.webp');
const GOKAI_CLOUD_2 = assetUrl('gokai02.webp');
const GOKAI_CLOUD_3 = assetUrl('gokai03.webp');
const GOKAI_ANSWER = assetUrl('gokai01a.webp');
const GOKAI_ANSWER_2 = assetUrl('gokai02a.webp');
const GOKAI_ANSWER_3 = assetUrl('gokai03a.webp');
const FUBUKI_LEFT = assetUrl('fubuki01.webp');
const FUBUKI_RIGHT = assetUrl('fubuki02.webp');
...
// Data Definitions
// ==========================================
const TARGET_SERVICES: { category: string; items: string[] }[] = [
  {
    category: '1. 施設系サービス',
    items: [
      '介護老人福祉施設（特別養護老人ホーム）',
...
const QUESTIONS: { id: number; cloudText: string; sunText: string; detail: string }[] = [
  {
    id: 0,
...
const FULL_CHECKLIST_DATA: ChecklistSectionData[] = [
  {
...
function Phase1_Intro({ onNext }: { onNext: () => void }) {
  return (
